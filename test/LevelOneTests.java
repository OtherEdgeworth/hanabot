...
public class LevelOneTests
{
    ...
    public void interpretationQ1()
    {
        ...
        // Q: Alice clues Cathy on Green - A: slot 4 (index 3) is focus, g 3 PLAY clue
    ...
    public void interpretationQ2()
    {
        ...
        // Q: Alice clues Bob on 2 - A: slot 5 (index 4) is focus, [b, g, y] 2 PLAY clue (as all other 2s are useless)
        ...
        Assertions.assertEquals(List.of(new String[] { "b", "g", "y" }), bobClue.possibleSuits);
    }
    ...
    public void interpretationQ3()
    {
        ...
        // Q: Alice clues Bob on Red - A: slot 2 (index 1) is focus, r 3 DELAYED_PLAY
    ...
    public void interpretationQ4()
    {
        ...
        // Q: Alice clues Bob on Blue - A: slot 4 (index 3) is focus, b 3 DELAYED_PLAY, b 4 CRITICAL_SAVE
